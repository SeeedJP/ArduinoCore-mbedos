...
#define CLOCK_SOURCE                                                          USE_PLL_HSE_XTAL|USE_PLL_HSI                                                                     // set by target:WIO_3G
#define CLOCK_SOURCE_USB                                                      1                                                                                                // set by target:WIO_3G
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       CELLULAR                                                                                         // set by target:WIO_3G
...
#define MODEM_ON_BOARD                                                        1                                                                                                // set by target:WIO_3G
#define MODEM_ON_BOARD_UART                                                   1                                                                                                // set by target:WIO_3G
